 ...
 */ function D(t) {
    ...
    if (N.logLevel <= c.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, E([ "Firestore (8.6.4): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= c.ERROR) {
        var r = e.map(C);
        N.error.apply(N, E([ "Firestore (8.6.4): " + t ], r));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= c.WARN) {
        var r = e.map(C);
        N.warn.apply(N, E([ "Firestore (8.6.4): " + t ], r));
    }
}
 ...
 */ function L(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (8.6.4) INTERNAL ASSERTION FAILED: " + t;
 ...
 */
    ...
    t.prototype.Fi = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/8.6.4", 
...
//# sourceMappingURL=prebuilt-2d0fb745-aea3db4c.js.map
