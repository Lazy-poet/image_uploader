 ...
 */ function k(t) {
    ...
    if (D.logLevel <= h.DEBUG) {
        var r = e.map(R);
        D.debug.apply(D, I([ "Firestore (8.6.4): " + t ], r));
    }
}
...
function x(t) {
    ...
    if (D.logLevel <= h.ERROR) {
        var r = e.map(R);
        D.error.apply(D, I([ "Firestore (8.6.4): " + t ], r));
    }
}
...
function C(t) {
    ...
    if (D.logLevel <= h.WARN) {
        var r = e.map(R);
        D.warn.apply(D, I([ "Firestore (8.6.4): " + t ], r));
    }
}
...
//# sourceMappingURL=prebuilt-db9cc925-eb007c37.js.map
